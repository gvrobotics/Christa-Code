...
//    double cpi = 7; // cycles per inch
    double cpi = 40; // cpi is being tested!!
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        strafe(robotStrafe.strafeLeft, 5, 0.3);

        sleep(500);

        strafe(robotStrafe.strafeRight, 5, 0.3);
    ...
    private void strafe(robotStrafe action, double inch,  double power)
    {
